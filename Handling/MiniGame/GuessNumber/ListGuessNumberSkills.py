...
list_special_items_cap_thap = [
    ...
    SpecialItem(
        item_id="ct_ban",
        item_name="Câm Lặng",
        item_description=f"Kỹ năng này sẽ khoá miệng đối phương, ban đối phương khỏi trò chơi nối từ trong vài vòng nhất định. Cách sử dụng rất đơn giản, chỉ việc nhập đúng lệnh như thế này: {SlashCommand.SKILL_USE.value}",
        quantity = 1,
        point=2,
        level="Cấp Thấp",
        required_target=True
...
list_special_items_cap_cao = [
    ...
    SpecialItem(
        item_id="cc_ban",
        item_name="Câm Lặng",
        item_description=f"Kỹ năng này sẽ khoá miệng đối phương, ban đối phương khỏi trò chơi nối từ trong nhiều vòng nhất định. Cách sử dụng rất đơn giản, chỉ việc nhập đúng lệnh như thế này: {SlashCommand.SKILL_USE.value}",
        quantity = 1,
        point=4,
        level="Cấp Cao",
        required_target=True
