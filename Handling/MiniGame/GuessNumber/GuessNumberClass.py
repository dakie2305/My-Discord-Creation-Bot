...
class GuessNumberInfo:
    def __init__(self, channel_id: int, channel_name: str, guild_name: str, range_from: int = None, range_to: int = None, correct_number: int = None, special_point: int = None, current_round: int = 0, player_profiles: Optional[List['PlayerProfile']] = None, player_effects : Optional[List['PlayerEffect']] = None, player_penalty : Optional[List['PlayerPenalty']] = None, player_ban : Optional[List['PlayerBan']] = None, special_item: Optional['SpecialItem'] = None, last_played = datetime.now()):
