...
class MwGiveSkillView(discord.ui.View):
    def __init__(self, user: discord.Member, target: discord.Member, channel_id: str, lan: str, list_embed: list[discord.Embed], all_skills: list[MwClass.SpecialItem]):
...
class GiveSkillInputModal(discord.ui.Modal):
    def __init__(self, user: discord.Member, target: discord.Member, channel_id: str, lan: str, list_skills: list[MwClass.SpecialItem]):
