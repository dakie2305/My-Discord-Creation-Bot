...
quest_romance_letter = [
    ...
    GuardianQuestLines(
        ...
        choice_a="Ôm lấy {guardian.ga_name}, hứa sẽ giúp đỡ.",
        ...
        next_steps=NextSteps(
            choice_a="comfort_guardian_promise",
...
quest_red_promises = [
    ...
    GuardianQuestLines(
        ...
        choice_a="Cố gắng giải cứu những người lính bị biến đổi.",
        ...
        next_steps=NextSteps(
            choice_a="attempt_rescue_soldiers",
