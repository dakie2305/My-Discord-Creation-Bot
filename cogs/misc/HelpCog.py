...
class Help(commands.Cog):
    ...
    def get_list_help_creation_2(self):
        ...
        embed.add_field(name="", value=f"{EmojiCreation2.SHINY_POINT.value}Liên Thông Hộ Vệ Thần là chức năng cho phép bạn có thể đồng bộ dữ liệu Hộ Vệ Thần của bản thân ở server khác!", inline=False)
