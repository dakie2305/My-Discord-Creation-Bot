...
async def get_proper_prompt(message: discord.Message, bot_name: str, extra_message: discord.Message = None):
    ...
    if message.author.id == user_darkie['user_id']:
        roleplay_ele = f"{initial_instruction} {background} **Đối phương là Đấng Tạo Hoá Darkie của ngươi. Ngươi đang nói chuyện với Đấng Tạo Hoá Darkie nên hãy kỉnh trọng.**\n"
