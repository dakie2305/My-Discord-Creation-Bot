...
def get_special_relationship_custom(message: discord.Message, bot_name: str):
    ...
    #nếu đang là Creation 2, và đối phương là Creation 1
        ...
        relationship = f"**Đối phương là anh trai của ngươi, ngươi đang nói chuyện với anh trai của mình, Creation 1. Luôn luôn sử dụng đại từ nhân xưng là em, và gọi đối phương là anh trai!**\n"
